...
import com.lk.backend.model.dto.chart.*;
...
import com.lk.backend.model.vo.ChartVo;
...
public class ChartController {
    ...
    public BaseResponse<AiResponseVo> genChartAsyncAiRebuild(ChartRebuildRequest chartRebuildRequest, HttpServletRequest request) {
